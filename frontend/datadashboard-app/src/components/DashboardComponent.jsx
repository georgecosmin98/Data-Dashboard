...
class DashboardComponent extends Component {
    ...
    componentDidMount() {
        UserLocationService.retrievePollutionValues("2021-04-05")
           .then(
               response => {
    ...
    render() {
        ...
        return (
            <div className="dashboard">
                ...
                {isLoggedIn &&<LineChartComponent data={this.state.data}></LineChartComponent>}
                <div class="flex-break"></div>
                {isLoggedIn &&<BarChartComponent data={this.state.data}></BarChartComponent>}
            </div>
        )
    }
}
